      ...
      >
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3">
              <UBadge
                :color="user.role === 'directeur' ? 'primary' : 'neutral'"
                variant="subtle"
                size="sm"
              >
                {{ $t(`roles.${user.role}`) }}
        ...
        <div class="p-6">
          ...
          <div class="space-y-4">
            ...
            <template v-if="isFondateurRole">
              ...
              <div
                v-if="users.searchResult === null && searchQuery && !users.searching"
      ...
      <template #content>
        <div class="p-6 text-center">
          ...
          <p class="mb-4 text-sm text-gray-500">
            {{ $t('users.passwordInfo', { name: createdUserName }) }}
          </p>

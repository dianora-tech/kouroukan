...
<template>
  ...
  >
    <UFormField
      :label="t('evaluations.note.evaluationId')"
      name="evaluationId"
      required
    >
      <UInput
        v-model.number="state.evaluationId"
        type="number"
        :placeholder="t('evaluations.note.evaluationPlaceholder')"
        class="w-full"
      />
    </UFormField>

    <UFormField
      :label="t('evaluations.note.eleveId')"
      name="eleveId"
      required
    >
      <UInput
        ...
        type="number"
        :placeholder="t('evaluations.note.elevePlaceholder')"
        class="w-full"
      />
    </UFormField>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <UFormField
        :label="t('evaluations.note.valeur')"
        name="valeur"
        required
      >
        <UInput
          v-model.number="state.valeur"
          type="number"
          min="0"
          step="0.25"
          class="w-full"
      ...
      <UFormField
        :label="t('evaluations.note.dateSaisie')"
        name="dateSaisie"
        required
      >
        <UInput
          v-model="state.dateSaisie"
          type="date"
          class="w-full"
        />
      </UFormField>
    ...
    <UFormField
      :label="t('evaluations.note.commentaire')"
      name="commentaire"
    >
      <UTextarea
        v-model="state.commentaire"
        :placeholder="t('evaluations.note.commentairePlaceholder')"
        class="w-full"
      />
    </UFormField>

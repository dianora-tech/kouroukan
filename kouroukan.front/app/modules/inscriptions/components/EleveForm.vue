...
<template>
  ...
  >
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <UFormField
        :label="t('inscriptions.eleve.firstName')"
        name="firstName"
        required
      >
        <UInput
          v-model="state.firstName"
          :placeholder="t('inscriptions.eleve.firstNamePlaceholder')"
          class="w-full"
        />
      </UFormField>

      <UFormField
        :label="t('inscriptions.eleve.lastName')"
        name="lastName"
        required
      >
        <UInput
          v-model="state.lastName"
          :placeholder="t('inscriptions.eleve.lastNamePlaceholder')"
          class="w-full"
        />
      </UFormField>
    </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <UFormField
        :label="t('inscriptions.eleve.dateNaissance')"
        name="dateNaissance"
        required
      >
        <UInput
          v-model="state.dateNaissance"
          type="date"
          class="w-full"
        />
      </UFormField>
      ...
      <UFormField
        :label="t('inscriptions.eleve.lieuNaissance')"
        name="lieuNaissance"
        required
      >
        <UInput
          v-model="state.lieuNaissance"
          :placeholder="t('inscriptions.eleve.lieuNaissancePlaceholder')"
          class="w-full"
        />
      </UFormField>
    </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <UFormField
        :label="t('inscriptions.eleve.genre')"
        name="genre"
        required
      >
        <USelect
      ...
      <UFormField
        :label="t('inscriptions.eleve.nationalite')"
        name="nationalite"
        required
      >
        <UInput
          v-model="state.nationalite"
          :placeholder="t('inscriptions.eleve.nationalitePlaceholder')"
          class="w-full"
        />
      </UFormField>
    </div>
    ...
    <UFormField
      :label="t('inscriptions.eleve.adresse')"
      name="adresse"
    >
      <UTextarea
        v-model="state.adresse"
        :placeholder="t('inscriptions.eleve.adressePlaceholder')"
        class="w-full"
      />
    </UFormField>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <UFormField
        :label="t('inscriptions.eleve.numeroMatricule')"
        name="numeroMatricule"
        required
      >
        <UInput
          v-model="state.numeroMatricule"
          :placeholder="t('inscriptions.eleve.matriculePlaceholder')"
          class="w-full"
        />
      </UFormField>

      <UFormField
        :label="t('inscriptions.eleve.statutInscription')"
    ...
    <UFormField
      :label="t('inscriptions.eleve.photoUrl')"
      name="photoUrl"
    >
      <UInput
        v-model="state.photoUrl"
        type="url"
        :placeholder="t('inscriptions.eleve.photoUrlPlaceholder')"
        class="w-full"
      />
    </UFormField>

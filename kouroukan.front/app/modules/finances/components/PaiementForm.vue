...
<template>
  ...
  >
    <UFormField
      :label="t('finances.paiement.typeId')"
      name="typeId"
      required
    >
      <USelect
        ...
        :items="typeOptions"
        value-key="value"
        :placeholder="t('finances.paiement.typePlaceholder')"
        class="w-full"
      />
    </UFormField>

    <UFormField
      :label="t('finances.paiement.numeroRecu')"
      name="numeroRecu"
      required
    >
      <UInput
        v-model="state.numeroRecu"
        :placeholder="t('finances.paiement.numeroRecuPlaceholder')"
        class="w-full"
      />
    </UFormField>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <UFormField
        :label="t('finances.paiement.montantPaye')"
        name="montantPaye"
        required
      >
        <UInput
      ...
      <UFormField
        :label="t('finances.paiement.datePaiement')"
        name="datePaiement"
        required
      >
        <UInput
          v-model="state.datePaiement"
          type="date"
          class="w-full"
        />
      </UFormField>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <UFormField
        :label="t('finances.paiement.moyenPaiement')"
        name="moyenPaiement"
        required
      >
        <USelect
          v-model="state.moyenPaiement"
          :items="moyenOptions"
          value-key="value"
          class="w-full"
        />
      ...
      <UFormField
        :label="t('finances.paiement.statutPaiement')"
        name="statutPaiement"
        required
      >
        <USelect
    ...
    <UFormField
      v-if="isMobileMoney"
      :label="t('finances.paiement.referenceMobileMoney')"
      name="referenceMobileMoney"
    >
      <UInput
        v-model="state.referenceMobileMoney"
        :placeholder="t('finances.paiement.referencePlaceholder')"
        class="w-full"
      />
    </UFormField>

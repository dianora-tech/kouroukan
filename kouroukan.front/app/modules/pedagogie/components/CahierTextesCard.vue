...
<template>
  <div class="rounded-lg border border-gray-200 bg-white p-4 transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-gray-900">
    <div class="flex items-start justify-between">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p v-if="cahier.classeName" class="text-sm text-gray-500 dark:text-gray-400">
            {{ cahier.classeName }}
          </p>
        </div>
      </div>
    ...
    <div class="mt-3 space-y-2">
      ...
      <div v-if="cahier.travailAFaire" class="rounded-md bg-amber-50 p-2 dark:bg-amber-900/20">
        <p class="text-xs font-medium text-amber-700 dark:text-amber-300">
          <UIcon name="i-heroicons-pencil" class="mr-1 inline h-3 w-3" />

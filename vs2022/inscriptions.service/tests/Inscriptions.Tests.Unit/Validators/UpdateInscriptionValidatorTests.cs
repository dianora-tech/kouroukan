...
/// <summary>
/// Tests unitaires pour UpdateInscriptionValidator.
/// </summary>
public sealed class UpdateInscriptionValidatorTests
{
    private readonly UpdateInscriptionValidator _validator;

    public UpdateInscriptionValidatorTests()
    {
        _validator = new UpdateInscriptionValidator();
    }
    ...
    [InlineData("Validee")]
    [InlineData("Annulee")]
    public void StatutInscription_Valide_PasDerreur(string statut)
    {
    ...
    [Fact]
    public void SerieBac_Null_PasDerreur()
    {
        var command = CreateValidCommand() with { SerieBac = null };
    ...
    private static UpdateInscriptionCommand CreateValidCommand()
    {

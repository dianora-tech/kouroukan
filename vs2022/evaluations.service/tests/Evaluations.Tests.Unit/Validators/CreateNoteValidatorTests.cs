...
/// <summary>
/// Tests unitaires pour CreateNoteValidator.
/// </summary>
public sealed class CreateNoteValidatorTests
{
    ...
    [Fact]
    public void EvaluationId_Negatif_Erreur()
    {
        var command = CreateValidCommand() with { EvaluationId = -1 };
    ...
    [Fact]
    public void Commentaire_500Caracteres_PasDerreur()
    {
        var command = CreateValidCommand() with { Commentaire = new string('A', 500) };
    ...
    private static CreateNoteCommand CreateValidCommand()
    {

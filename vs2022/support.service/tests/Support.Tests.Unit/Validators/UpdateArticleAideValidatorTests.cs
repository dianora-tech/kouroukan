...
/// <summary>
/// Tests unitaires pour UpdateArticleAideValidator.
/// </summary>
public sealed class UpdateArticleAideValidatorTests
{
    private readonly UpdateArticleAideValidator _validator;

    public UpdateArticleAideValidatorTests()
    {
        _validator = new UpdateArticleAideValidator();
    }
    ...
    private static UpdateArticleAideCommand CreateValidCommand()
    {
        return new UpdateArticleAideCommand(
            Id: 1,

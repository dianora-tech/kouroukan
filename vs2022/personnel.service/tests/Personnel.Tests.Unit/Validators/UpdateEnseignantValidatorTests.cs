...
/// <summary>
/// Tests unitaires pour UpdateEnseignantValidator.
/// </summary>
public sealed class UpdateEnseignantValidatorTests
{
    private readonly UpdateEnseignantValidator _validator;

    public UpdateEnseignantValidatorTests()
    {
        _validator = new UpdateEnseignantValidator();
    }
    ...
    private static UpdateEnseignantCommand CreateValidCommand()
    {
        return new UpdateEnseignantCommand(
            Id: 1,
            Name: "Mamadou Diallo",

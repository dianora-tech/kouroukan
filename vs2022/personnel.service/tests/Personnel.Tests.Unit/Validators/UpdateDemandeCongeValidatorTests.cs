...
/// <summary>
/// Tests unitaires pour UpdateDemandeCongeValidator.
/// </summary>
public sealed class UpdateDemandeCongeValidatorTests
{
    private readonly UpdateDemandeCongeValidator _validator;

    public UpdateDemandeCongeValidatorTests()
    {
        _validator = new UpdateDemandeCongeValidator();
    }
    ...
    {
        var command = CreateValidCommand() with { PieceJointeUrl = "https://docs.example.com/doc.pdf" };
    ...
    private static UpdateDemandeCongeCommand CreateValidCommand()
    {
        return new UpdateDemandeCongeCommand(
            Id: 1,
            Name: "Conge annuel",
